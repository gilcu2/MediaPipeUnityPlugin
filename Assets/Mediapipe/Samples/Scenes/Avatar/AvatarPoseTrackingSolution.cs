...
namespace Mediapipe.Unity.AvatarPoseTracking
{
  public class AvatarPoseTrackingSolution : Solution
  {
    ...
    [SerializeField] private AvatarPoseTrackingGraph _graphRunner;
    ...
    public AvatarPoseTrackingGraph.ModelComplexity modelComplexity
    {
