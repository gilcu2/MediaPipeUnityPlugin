...
namespace Mediapipe.Unity.AvatarPoseTracking.UI
{
  public class PoseTrackingConfig : ModalContents
  {
    ...
    private AvatarPoseTrackingSolution _solution;
    ...
    private void Start()
    {
      _solution = GameObject.Find("Solution").GetComponent<AvatarPoseTrackingSolution>();
      InitializeContents();
    }
    ...
    {
      _solution.modelComplexity = (AvatarPoseTrackingGraph.ModelComplexity)_modelComplexityInput.value;
      _isChanged = true;
    }
    ...
    private void InitializeModelComplexity()
    {
      ...
      var options = new List<string>(Enum.GetNames(typeof(AvatarPoseTrackingGraph.ModelComplexity)));
